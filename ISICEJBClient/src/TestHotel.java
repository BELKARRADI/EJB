...
final Context context = new InitialContext(jndiProperties);
		...
		return (IDaoRemote<Ville>) context.lookup("ejb:ISICEJBEAR/ISICEJBServer/belkVille!dao.IDaoRemote");
...
final Context context = new InitialContext(jndiProperties);
		...
		return (IDaoRemote<Hotel>) context.lookup("ejb:ISICEJBEAR/ISICEJBServer/belkHotel!dao.IDaoRemote");
